  ...
  <div>
    <div class="ppnp-container">
      ...
      <div class="ppnp-number-container">
        <p class="black ppnp-p-number">03</p>
      </div>
    </div>
    ...
    <pcase
      heading="Preface"
      para=" Bharat Rohan is a knowledge company empowering Indian farmers with extraordinary
      in-depth understanding of their lands and crop health using airborne Hyper spectral Imagery,
      data mining and analytics technology. Bharat Rohan collects valuable data by flying our UAV (or drone)
      platforms equipped with Hyper spectral Cameras and transforms it into actionable information to generate
      early pest alerts, conduct crop nutrition diagnostics, detect weed anomalies and perform
      yield predictions. This ensures reduction in losses for farming community and increase in profit margins. "
      theme="theme_br"
    />
    <pcase
      heading="Challenge"
    ...
    <div class="p-image-100-duo">
      <div class="reveal-holder" data-aos="fade-up" data-aos-once="true">
        ...
        <img src="~assets/projects/bharatrohan/BharatRohan7.jpg" />
      </div>
    </div>
