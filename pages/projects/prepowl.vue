<template>
  ...
  <div>
    ...
    <div class="p-quote contain red">
      <blockquote>
       Making hypothesis is awesome but at the end of the day that hypothesis better turn for the better of the project.
      </blockquote>
    </div>
